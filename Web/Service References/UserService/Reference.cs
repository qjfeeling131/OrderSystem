...
namespace Web.UserService {
    ...
    public interface IUserService {
        ...
        System.Collections.Generic.List<OrderManager.Model.DTO.OM_ProductInfo> GetProductList(string cipher, string searchKey, int pageIndex);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserService/GetProductList", ReplyAction="http://tempuri.org/IUserService/GetProductListResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<OrderManager.Model.DTO.OM_ProductInfo>> GetProductListAsync(string cipher, string searchKey, int pageIndex);
    ...
    public partial class UserServiceClient : System.ServiceModel.ClientBase<Web.UserService.IUserService>, Web.UserService.IUserService {
        ...
        public System.Collections.Generic.List<OrderManager.Model.DTO.OM_ProductInfo> GetProductList(string cipher, string searchKey, int pageIndex) {
            return base.Channel.GetProductList(cipher, searchKey, pageIndex);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<OrderManager.Model.DTO.OM_ProductInfo>> GetProductListAsync(string cipher, string searchKey, int pageIndex) {
