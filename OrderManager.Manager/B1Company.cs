...
namespace OrderManager.Manager
{
    public class B1Company : IDisposable
    {
        ...
        public bool SaveSalesOrderDraft(OM_SalesOrderDataObject salesOrder)
        {
            ...
            try
            {
                //oSaleOrder.CardCode = "CJ0003";
                //oSaleOrder.CardName = "A003广东番禺东兴HD+HC";
                ...
                //oSaleOrder.Lines.ItemCode = "HSFC000522";
                //oSaleOrder.Lines.ItemDescription = "HC-Z02，休闲椅，840*860*700，胡桃木";
                //oSaleOrder.Lines.Quantity = 5.0;
                //oSaleOrder.Lines.Price = 37.9;
